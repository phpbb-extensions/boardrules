...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'O destino contém atualmente %d regra. Ela permanecerá inalterada e as regras copiadas serão adicionadas depois dela. As âncoras copiadas em conflito receberão um sufixo numérico.',
		2 => 'O destino contém atualmente %d regras. Elas permanecerão inalteradas e as regras copiadas serão adicionadas depois delas. As âncoras copiadas em conflito receberão um sufixo numérico.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Tem certeza que deseja remover esta regra?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Tem certeza que deseja remover esta categoria de regra?<br />Aviso: Removendo um categoria de regra irá remover todas as regras contidas dentro dela.',
