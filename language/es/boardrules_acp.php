...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Copia cada categoría y norma en <strong>%s</strong>. Las normas copiadas se añaden después de las existentes y el conjunto completo de destino se establecerá como borrador hasta que se publique.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Añadir a las normas existentes',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'El destino contiene actualmente %d norma. Permanecerá sin cambios y las normas copiadas se añadirán después. Los anclajes copiados que entren en conflicto recibirán un sufijo numérico.',
		2 => 'El destino contiene actualmente %d normas. Permanecerán sin cambios y las normas copiadas se añadirán después. Los anclajes copiados que entren en conflicto recibirán un sufijo numérico.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d norma copiada a %2$s como borrador.',
		2 => '%1$d normas copiadas a %2$s como borrador.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => 'Se cambió el nombre de %d anclaje en conflicto con un sufijo numérico.',
		2 => 'Se cambiaron los nombres de %d anclajes en conflicto con sufijos numéricos.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> '¿Está seguro de querer borrar esta norma?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> '¿Está seguro de querer borrar esta norma de categoría?<br />Advertencia: Al eliminar una norma de categoría también eliminará todas las normas contenidas de la misma.',
