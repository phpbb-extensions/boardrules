...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'העתק כל קטגוריה וחוק אל <strong>%s</strong>. החוקים המועתקים יתווספו אחרי החוקים הקיימים, ומערכת החוקים המלאה בשפת היעד תוגדר כטיוטה עד שתפורסם.',
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'האם אתה בטוח שברצונך למחוק חוק זה ?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'האם אתה בטוח שברצונך למחוק חוק זה ?<br />אזהרה: מחיקת קטגוריית חוקים תמחק גם את כל החוקים בתוכה.',
