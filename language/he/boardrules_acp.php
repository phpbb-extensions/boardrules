...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'הזן את המבוא שיוצג מעל החוקים למשתמשים הצופים בערכת החוקים <strong>%s</strong>. השאר שדה זה ריק כדי להשתמש בטקסט ברירת המחדל המתורגם שמוצג כמציין מקום.',
