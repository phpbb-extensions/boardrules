...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_LANGUAGE_EXPLAIN'		=> 'Изберете език за правилата. Потребителите ще виждат правилата на предпочитания си език или правилата на езика по подразбиране, ако няма такива на предпочитания език.',
