...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'Въведете въведението, което се показва над правилата за потребителите, разглеждащи набора от правила на <strong>%s</strong>. Оставете полето празно, за да използвате преведения текст по подразбиране, показан като подсказка.',
	...
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> 'В момента целта съдържа %d правила. Те ще останат непроменени, а копираните правила ще бъдат добавени след тях. Конфликтните копирани котви ще получат цифров суфикс.',
	...
	'ACP_BOARDRULES_RULE_COUNT'				=> '%d правила',
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> '%1$d правила са копирани в %2$s като чернова.',
