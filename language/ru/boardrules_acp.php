...
$lang = array_merge($lang, array(
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Вы действительно хотите удалить данное правило?<br />Предупреждение: удаление раздела правил также приведёт к удалению всех входящих в него пунктов.',
