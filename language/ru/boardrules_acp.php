...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Копирует все категории и правила в <strong>%s</strong>. Скопированные правила добавляются после существующих, а полный целевой набор правил будет переведён в статус черновика до публикации.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Добавить к существующим правилам',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Сейчас целевой язык содержит %d правило. Оно останется без изменений, а скопированные правила будут добавлены после него. Конфликтующие скопированные якоря получат числовой суффикс.',
		2 => 'Сейчас целевой язык содержит %d правила. Они останутся без изменений, а скопированные правила будут добавлены после них. Конфликтующие скопированные якоря получат числовой суффикс.',
		3 => 'Сейчас целевой язык содержит %d правил. Они останутся без изменений, а скопированные правила будут добавлены после них. Конфликтующие скопированные якоря получат числовой суффикс.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d правило скопировано в %2$s как черновик.',
		2 => '%1$d правила скопированы в %2$s как черновик.',
		3 => '%1$d правил скопировано в %2$s как черновик.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d конфликтующий якорь переименован с добавлением числового суффикса.',
		2 => '%d конфликтующих якоря переименованы с добавлением числовых суффиксов.',
		3 => '%d конфликтующих якорей переименовано с добавлением числовых суффиксов.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Вы действительно хотите удалить данное правило?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Вы действительно хотите удалить данное правило?<br />Предупреждение: удаление раздела правил также приведёт к удалению всех входящих в него пунктов.',
