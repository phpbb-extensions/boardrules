...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		...
		2 => 'تحتوي اللغة الهدف حالياً على %d من القوانين. ستبقى دون تغيير، وستُضاف القوانين المنسوخة بعدها. ستُضاف لاحقة رقمية إلى المراسي المنسوخة المتعارضة.',
		3 => 'تحتوي اللغة الهدف حالياً على %d من القوانين. ستبقى دون تغيير، وستُضاف القوانين المنسوخة بعدها. ستُضاف لاحقة رقمية إلى المراسي المنسوخة المتعارضة.',
		4 => 'تحتوي اللغة الهدف حالياً على %d من القوانين. ستبقى دون تغيير، وستُضاف القوانين المنسوخة بعدها. ستُضاف لاحقة رقمية إلى المراسي المنسوخة المتعارضة.',
		5 => 'تحتوي اللغة الهدف حالياً على %d من القوانين. ستبقى دون تغيير، وستُضاف القوانين المنسوخة بعدها. ستُضاف لاحقة رقمية إلى المراسي المنسوخة المتعارضة.',
		6 => 'تحتوي اللغة الهدف حالياً على %d من القوانين. ستبقى دون تغيير، وستُضاف القوانين المنسوخة بعدها. ستُضاف لاحقة رقمية إلى المراسي المنسوخة المتعارضة.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => 'نُسخ %1$d قانون إلى %2$s كمسودة.',
		2 => 'نُسخ %1$d من القوانين إلى %2$s كمسودة.',
		3 => 'نُسخ %1$d من القوانين إلى %2$s كمسودة.',
		4 => 'نُسخ %1$d من القوانين إلى %2$s كمسودة.',
		5 => 'نُسخ %1$d من القوانين إلى %2$s كمسودة.',
		6 => 'نُسخ %1$d من القوانين إلى %2$s كمسودة.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => 'أُعيدت تسمية %d مرساة متعارضة باستخدام لاحقة رقمية.',
		2 => 'أُعيدت تسمية %d من المراسي المتعارضة باستخدام لواحق رقمية.',
		3 => 'أُعيدت تسمية %d من المراسي المتعارضة باستخدام لواحق رقمية.',
		4 => 'أُعيدت تسمية %d من المراسي المتعارضة باستخدام لواحق رقمية.',
		5 => 'أُعيدت تسمية %d من المراسي المتعارضة باستخدام لواحق رقمية.',
		6 => 'أُعيدت تسمية %d من المراسي المتعارضة باستخدام لواحق رقمية.',
	),
