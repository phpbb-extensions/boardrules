...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'أدخل المقدمة التي تظهر أعلى القوانين للمستخدمين الذين يشاهدون مجموعة قوانين <strong>%s</strong>. اترك هذا الحقل فارغًا لاستخدام النص الافتراضي المترجم الظاهر كعنصر نائب.',
