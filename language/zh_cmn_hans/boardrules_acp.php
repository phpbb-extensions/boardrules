...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> '将每个分类和章程复制到<strong>%s</strong>。复制的章程将添加到任何现有章程之后，完整的目标章程集将被设为草稿，直到您发布为止。',
	'ACP_BOARDRULES_COPY_APPEND'			=> '添加到现有章程',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => '目标目前包含 %d 条章程。它们将保持不变，复制的章程将添加到其后。任何冲突的已复制锚点都将获得数字后缀。',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '已将 %1$d 条章程作为草稿复制到%2$s。',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d 个冲突的锚点已使用数字后缀重命名。',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> '您确认要删除这条章程？',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> '您确认要删除这条章程？<br />警告：删除分类会删除所有其包含的章程。',
