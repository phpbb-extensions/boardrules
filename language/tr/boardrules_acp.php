...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> '<strong>%s</strong> kural kümesini görüntüleyen kullanıcılara kuralların üzerinde gösterilecek giriş metnini girin. Yer tutucu olarak gösterilen çevrilmiş varsayılan metni kullanmak için bu alanı boş bırakın.',
	...
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> 'Hedef şu anda %d kural içeriyor. Bu kurallar değişmeden kalacak ve kopyalanan kurallar onların ardından eklenecek. Çakışan kopyalanmış bağlantı çapalarına sayısal bir son ek verilecek.',
	...
	'ACP_BOARDRULES_RULE_COUNT'				=> '%d kural',
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> '%1$d kural %2$s diline taslak olarak kopyalandı.',
