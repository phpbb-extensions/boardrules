...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_MANAGE_ACTION'			=> 'Yönet',
	'ACP_BOARDRULES_COPY_ACTION'			=> 'Kuralları kopyala',
	'ACP_BOARDRULES_PUBLISH'				=> 'Yayınla',
	'ACP_BOARDRULES_SET_DRAFT'				=> 'Taslak olarak ayarla',
	'ACP_BOARDRULES_ALL_LANGUAGES'			=> 'Tüm diller',
	'ACP_BOARDRULES_DEFAULT_LANGUAGE'		=> 'Varsayılan dil',
	'ACP_BOARDRULES_EMPTY_NOTICE'			=> 'Bu dilde kural yok. Kullanıcılar şu anda forumun varsayılan dilindeki kuralları görüyor.',
	'ACP_BOARDRULES_EMPTY_DEFAULT_NOTICE'	=> 'Forumun varsayılan dilinde kural yok.',
	'ACP_BOARDRULES_DRAFT_NOTICE'			=> 'Bu kurallar kullanıcılar tarafından görülemez. Kullanıcılar şu anda forumun varsayılan dilindeki kuralları görüyor.',
	'ACP_BOARDRULES_DRAFT_DEFAULT_NOTICE'	=> 'Bu kurallar kullanıcılar tarafından görülemez. Forumun varsayılan kurallarını kullanılabilir hale getirmek için yayınlayın.',
	'ACP_BOARDRULES_COPY_RULESET'			=> 'Dil kural kümesini kopyala',
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Tüm kategorileri ve kuralları <strong>%s</strong> diline kopyalayın. Kopyalanan kurallar mevcut kuralların ardından eklenir ve hedef kural kümesinin tamamı siz yayınlayana kadar taslak olarak ayarlanır.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Mevcut kurallara ekle',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Hedef şu anda %d kural içeriyor. Bu kurallar değişmeden kalacak ve kopyalanan kurallar onların ardından eklenecek. Çakışan kopyalanmış bağlantı çapalarına sayısal bir son ek verilecek.',
	),
	'ACP_BOARDRULES_COPY_SETTINGS'			=> 'Kopyalama ayarları',
	'ACP_BOARDRULES_COPY_SOURCE'			=> 'Şuradan kopyala',
	'ACP_BOARDRULES_COPY_SOURCE_EXPLAIN'	=> 'Tüm hiyerarşi, sıralama, başlıklar, mesajlar, bağlantı çapaları ve biçimlendirme ayarları kopyalanacak.',
	'ACP_BOARDRULES_COPY_TARGET'			=> 'Şuraya kopyala',
	'ACP_BOARDRULES_RULE_COUNT'				=> array(
		1 => '%d kural',
	),
	'ACP_BOARDRULES_COPY_INVALID_LANGUAGE'	=> 'Kaynak ve hedef, yüklü farklı diller olmalıdır.',
	'ACP_BOARDRULES_COPY_SOURCE_EMPTY'		=> 'Seçilen kaynak dilde kopyalanacak kural yok.',
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d kural %2$s diline taslak olarak kopyalandı.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d çakışan bağlantı çapası sayısal son eklerle yeniden adlandırıldı.',
	),
	...
	'ACP_BOARDRULES_DRAFT_SUCCESS'			=> 'Dil kural kümesi taslak olarak değiştirildi.',
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Bu kuralı kaldırmak istediğinize emin misiniz?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Bu kuralı kaldırmak istediğinize emin misiniz?<br />Dikkat: Bir kural kategorisi kaldırıldığında içerdiği tüm kurallar da kaldırılır.',
