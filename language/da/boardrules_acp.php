...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Kopiér alle kategorier og regler til <strong>%s</strong>. Kopierede regler tilføjes efter eksisterende regler, og hele destinationsregelsættet sættes som kladde, indtil du udgiver det.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Føj til eksisterende regler',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Destinationen indeholder i øjeblikket %d regel. Den forbliver uændret, og kopierede regler tilføjes efter den. Kopierede ankre med konflikter får et numerisk suffiks.',
		2 => 'Destinationen indeholder i øjeblikket %d regler. De forbliver uændrede, og kopierede regler tilføjes efter dem. Kopierede ankre med konflikter får et numerisk suffiks.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d regel blev kopieret til %2$s som kladde.',
		2 => '%1$d regler blev kopieret til %2$s som kladde.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d anker med konflikt blev omdøbt med et numerisk suffiks.',
		2 => '%d ankre med konflikter blev omdøbt med numeriske suffikser.',
	),
