...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_FONT_ICON_EXPLAIN'		=> 'Εισάγετε το όνομα του εικονιδίου από το <strong><a href="https://fontawesome.com/v4.7.0/icons/" target="_blank">Font Awesome</a></strong> που θα χρησιμοποιηθεί στον σύνδεσμο των Όρων Συμμετοχής. Αφήστε αυτό το πεδίο κενό αν δεν θέλετε να εμφανίζεται κάποιο εικονίδιο.',
