...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Αντιγράψτε κάθε κατηγορία και κανόνα στη γλώσσα <strong>%s</strong>. Οι αντιγραμμένοι κανόνες προστίθενται μετά από τυχόν υπάρχοντες και ολόκληρο το σύνολο κανόνων προορισμού θα οριστεί ως πρόχειρο μέχρι να το δημοσιεύσετε.',
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Είστε σίγουρος (-η) ότι θέλετε να διαγράψετε αυτό τον όρο.',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Είστε σίγουρος (-η) ότι θέλετε να διαγράψετε αυτό τον όρο.<br />Προσοχή: Διαγράφοντας μια κατηγορία όρων, θα διαγραφούν και όλοι οι όροι που περιέχονται σε αυτή.',
