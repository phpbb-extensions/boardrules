...
$lang = array_merge($lang, array(
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Είστε σίγουρος (-η) ότι θέλετε να διαγράψετε αυτό τον όρο;<br />Προσοχή: Διαγράφοντας μια κατηγορία όρων, θα διαγραφούν και όλοι οι όροι που περιέχονται σε αυτή.',
