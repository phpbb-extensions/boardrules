...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'Ange introduktionen som visas ovanför reglerna för användare som visar regeluppsättningen <strong>%s</strong>. Lämna fältet tomt för att använda den översatta standardtexten som visas som platshållare.',
