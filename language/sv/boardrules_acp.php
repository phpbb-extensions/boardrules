...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Kopiera alla kategorier och regler till <strong>%s</strong>. Kopierade regler läggs till efter befintliga regler och målspråkets fullständiga regeluppsättning sätts som utkast tills du publicerar den.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Lägg till i befintliga regler',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Målet innehåller för närvarande %d regel. Den förblir oförändrad och kopierade regler läggs till efter den. Kopierade ankare med konflikter får ett numeriskt suffix.',
		2 => 'Målet innehåller för närvarande %d regler. De förblir oförändrade och kopierade regler läggs till efter dem. Kopierade ankare med konflikter får ett numeriskt suffix.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d regel kopierades till %2$s som ett utkast.',
		2 => '%1$d regler kopierades till %2$s som ett utkast.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d ankare med konflikt döptes om med ett numeriskt suffix.',
		2 => '%d ankare med konflikter döptes om med numeriska suffix.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Är du säker på att du vill ta bort denna regel?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Är du säker på att du vill ta bort denna regelkategori?<br />Varning: raderas en regelkategori så raderas även alla regler i denna kategori.',
