...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO'					=> 'Introducerea paginii cu reguli',
	...
	'ACP_BOARDRULES_MANAGE_ACTION'			=> 'Gestionează',
	'ACP_BOARDRULES_COPY_ACTION'			=> 'Copiază regulile',
	'ACP_BOARDRULES_PUBLISH'				=> 'Publică',
	'ACP_BOARDRULES_SET_DRAFT'				=> 'Setează drept ciornă',
	'ACP_BOARDRULES_ALL_LANGUAGES'			=> 'Toate limbile',
	'ACP_BOARDRULES_DEFAULT_LANGUAGE'		=> 'Limba implicită',
	'ACP_BOARDRULES_EMPTY_NOTICE'			=> 'Nu există reguli în această limbă. Utilizatorii văd în prezent regulile în limba implicită a forumului.',
	'ACP_BOARDRULES_EMPTY_DEFAULT_NOTICE'	=> 'Nu există reguli în limba implicită a forumului.',
	'ACP_BOARDRULES_DRAFT_NOTICE'			=> 'Aceste reguli nu sunt vizibile utilizatorilor. Utilizatorii văd în prezent regulile în limba implicită a forumului.',
	'ACP_BOARDRULES_DRAFT_DEFAULT_NOTICE'	=> 'Aceste reguli nu sunt vizibile utilizatorilor. Publicați-le pentru a face disponibile regulile implicite ale forumului.',
	'ACP_BOARDRULES_COPY_RULESET'			=> 'Copiază setul de reguli al limbii',
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Copiați fiecare categorie și regulă în <strong>%s</strong>. Regulile copiate sunt adăugate după cele existente, iar setul complet de reguli țintă va fi setat ca ciornă până când îl publicați.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Adaugă la regulile existente',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Limba țintă conține în prezent %d regulă. Aceasta va rămâne neschimbată, iar regulile copiate vor fi adăugate după ea. Ancorele copiate care intră în conflict vor primi un sufix numeric.',
		2 => 'Limba țintă conține în prezent %d reguli. Acestea vor rămâne neschimbate, iar regulile copiate vor fi adăugate după ele. Ancorele copiate care intră în conflict vor primi un sufix numeric.',
		3 => 'Limba țintă conține în prezent %d reguli. Acestea vor rămâne neschimbate, iar regulile copiate vor fi adăugate după ele. Ancorele copiate care intră în conflict vor primi un sufix numeric.',
	),
	'ACP_BOARDRULES_COPY_SETTINGS'			=> 'Setări de copiere',
	'ACP_BOARDRULES_COPY_SOURCE'			=> 'Copiază din',
	'ACP_BOARDRULES_COPY_SOURCE_EXPLAIN'	=> 'Vor fi copiate ierarhia completă, ordinea, titlurile, mesajele, ancorele și setările de formatare.',
	'ACP_BOARDRULES_COPY_TARGET'			=> 'Copiază în',
	'ACP_BOARDRULES_RULE_COUNT'				=> array(
		1 => '%d regulă',
		2 => '%d reguli',
		3 => '%d reguli',
	),
	'ACP_BOARDRULES_COPY_INVALID_LANGUAGE'	=> 'Sursa și destinația trebuie să fie limbi instalate diferite.',
	'ACP_BOARDRULES_COPY_SOURCE_EMPTY'		=> 'Limba sursă selectată nu are reguli de copiat.',
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d regulă copiată în %2$s ca ciornă.',
		2 => '%1$d reguli copiate în %2$s ca ciornă.',
		3 => '%1$d reguli copiate în %2$s ca ciornă.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d ancoră aflată în conflict a fost redenumită cu un sufix numeric.',
		2 => '%d ancore aflate în conflict au fost redenumite cu sufixe numerice.',
		3 => '%d ancore aflate în conflict au fost redenumite cu sufixe numerice.',
	),
	...
	'ACP_BOARDRULES_DRAFT_SUCCESS'			=> 'Setul de reguli al limbii a fost schimbat în ciornă.',
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Esti sigur ca vrei sa stergi aceasta regula?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Esti sigur ca vrei sa stergi aceasta regula?<br />Avertisment: Eliminarea unei categorii reguli va duce la elimina toate regulile conținute în ea.',
