...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Kopier alle kategorier og regler til <strong>%s</strong>. Kopierte regler legges til etter eksisterende regler, og hele regelsettet for målspråket settes som utkast til du publiserer det.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Legg til i eksisterende regler',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Målet inneholder for øyeblikket %d regel. Den forblir uendret, og kopierte regler legges til etter den. Kopierte ankere med konflikter får et numerisk suffiks.',
		2 => 'Målet inneholder for øyeblikket %d regler. De forblir uendret, og kopierte regler legges til etter dem. Kopierte ankere med konflikter får et numerisk suffiks.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d regel ble kopiert til %2$s som et utkast.',
		2 => '%1$d regler ble kopiert til %2$s som et utkast.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d anker med konflikt fikk nytt navn med et numerisk suffiks.',
		2 => '%d ankere med konflikter fikk nye navn med numeriske suffikser.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Er du sikker på at du vil slette denne regelen?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Er du sikker på at du vil slette denne regelkategori?<br />Advarsel: Hvis en regelkategori blir slettet, slettes også alle reglene i den.',
