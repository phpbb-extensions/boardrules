...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'Enter the introduction shown above the rules for users viewing the <strong>%s</strong> ruleset. Leave this empty to use the translated default shown as the placeholder.',
	...
	'ACP_BOARDRULES_STATUS_EMPTY'			=> 'Using fallback',
	...
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> 'The target currently contains %d rules. They will remain unchanged, and copied rules will be added after them. Any conflicting copied anchors will receive a numeric suffix.',
	...
	'ACP_BOARDRULES_RULE_COUNT'				=> '%d rules',
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> '%1$d rules copied to %2$s as a draft.',
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> '%d conflicting anchors were renamed with numeric suffixes.',
	...
	'ACP_BOARDRULES_DEFAULT_CANNOT_DRAFT'	=> 'Board default language cannot be changed to draft.',
