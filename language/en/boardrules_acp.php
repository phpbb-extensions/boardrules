...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Copy every category and rule into <strong>%s</strong>. Copied rules are appended after any existing rules. The complete target ruleset will be set to draft until you publish it.',
	...
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Are you sure you want to remove this rule category?<br />Warning: Removing a rule category will also remove all rules contained within it.',
