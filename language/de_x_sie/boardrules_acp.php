...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_LIST_STYLE_EXPLAIN'		=> 'Wählen Sie die Kennzeichnung von Regeln und Kategorien. Geordnet wechselt zwischen Zahlen, Buchstaben und römischen Ziffern. Ungeordnet wechselt zwischen ausgefülltem Kreis, Kreis und Quadrat. Die Gliederungsnummerierung zeigt den vollständigen numerischen Pfad.',
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'Passen Sie die Einleitung an, die Benutzern auf der Regelseite <strong>%s</strong> angezeigt wird. Lassen Sie dieses Feld leer, um die als Platzhalter angezeigte Standardeinleitung zu verwenden.',
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Kopiert alle Kategorien und Regeln nach <strong>%s</strong>. Die kopierten Regeln werden hinter vorhandenen Regeln angefügt. Der vollständige Zielregelsatz wird als Entwurf festgelegt, bis Sie ihn veröffentlichen.',
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Sind Sie sicher, dass Sie diese Regel entfernen möchten?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Sind Sie sicher, dass diese Regel-Kategorie entfernt werden soll?<br />Warnung: Das Entfernen einer Regel-Kategorie wird auch alle darin enthaltenen Regeln entfernen.',
