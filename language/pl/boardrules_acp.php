...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_HEADER_LINK'			=> 'Wyświetlaj odnośnik do regulaminu witryny w nagłówku',
	'ACP_BOARDRULES_FONT_ICON'				=> 'Ikona regulaminu',
	'ACP_BOARDRULES_FONT_ICON_EXPLAIN'		=> 'Wprowadź nazwę ikony dostępną pod adresem <strong><a href="%s" target="_blank">Font Awesome</a></strong>, która będzie używana jako odnośnik do regulaminu w nagłówku witrynu. Pozostaw to pole puste, jeśli nie ma być ikony.',
	'ACP_BOARDRULES_FONT_ICON_INVALID'		=> 'Nazwa ikony do regulaminu witryny zawiera nieprawidłowe znaki.',
	...
	'ACP_BOARDRULES_LIST_STYLE'				=> 'Styl regulaminu',
	...
	'ACP_BOARDRULES_LIST_STYLE_ORDERED'		=> 'Uporządkowane alfanumeryczne',
	...
	'ACP_BOARDRULES_LIST_STYLE_NONE'		=> 'Brak',
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Kopiuje wszystkie rozdziały i przepisy do <strong>%s</strong>. Skopiowane przepisy są dodawane za istniejącymi, a cały regulamin docelowy zostanie ustawiony jako szkic do czasu publikacji.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Dodaj do istniejących przepisów',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Element docelowy zawiera obecnie %d przepis. Pozostanie on bez zmian, a skopiowane przepisy zostaną dodane za nim. Skopiowane zakotwiczenia powodujące konflikt otrzymają przyrostek liczbowy.',
		2 => 'Element docelowy zawiera obecnie %d przepisy. Pozostaną one bez zmian, a skopiowane przepisy zostaną dodane za nimi. Skopiowane zakotwiczenia powodujące konflikt otrzymają przyrostek liczbowy.',
		3 => 'Element docelowy zawiera obecnie %d przepisów. Pozostaną one bez zmian, a skopiowane przepisy zostaną dodane za nimi. Skopiowane zakotwiczenia powodujące konflikt otrzymają przyrostek liczbowy.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => 'Skopiowano %1$d przepis do języka %2$s jako szkic.',
		2 => 'Skopiowano %1$d przepisy do języka %2$s jako szkic.',
		3 => 'Skopiowano %1$d przepisów do języka %2$s jako szkic.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d zakotwiczenie powodujące konflikt otrzymało nową nazwę z przyrostkiem liczbowym.',
		2 => '%d zakotwiczenia powodujące konflikt otrzymały nowe nazwy z przyrostkami liczbowymi.',
		3 => 'Zmieniono nazwy %d zakotwiczeń powodujących konflikt, dodając przyrostki liczbowe.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Czy na pewno chcesz usunąć ten przepis?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Czy na pewno chcesz usunąć ten kategorii reguły?<br />Uwaga: Usunięcie kategorii reguły spowoduje także usunięcie wszystkich zawartych w nim zasad.',
	'ACP_RULE_ADDED'						=> 'Reguła została dodana.',
	'ACP_RULE_DELETED'						=> 'Reguła została usunięta.',
	'ACP_RULE_EDITED'						=> 'Reguła została zaktualizowana.',
	'ACP_RULE_TITLE_EMPTY'					=> 'Należy wprowadzić tytuł dla tej reguły.',
	...
	'RULES_NESTEDSET_LOCK_FAILED_ACQUIRE'	=> 'Reguły witryny nie uzyskały blokady tabeli. Inny proces może utrzymywać blokadę. Blokady są przymusowo zwalniane po upływie 1 godziny.',
	'RULES_NESTEDSET_INVALID_ITEM'			=> 'Żądana reguła nie istnieje.',
	'RULES_NESTEDSET_INVALID_PARENT'		=> 'Żądana reguła nie ma rodzica.',
));
