...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_LANGUAGE'				=> 'Lingua',
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Copia ogni categoria e regola in <strong>%s</strong>. Le regole copiate vengono aggiunte dopo quelle esistenti e l’intero set di regole di destinazione verrà impostato come bozza finché non verrà pubblicato.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Aggiungi alle regole esistenti',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'La destinazione contiene attualmente %d regola. Rimarrà invariata e le regole copiate verranno aggiunte dopo di essa. Gli ancoraggi copiati in conflitto riceveranno un suffisso numerico.',
		2 => 'La destinazione contiene attualmente %d regole. Rimarranno invariate e le regole copiate verranno aggiunte dopo di esse. Gli ancoraggi copiati in conflitto riceveranno un suffisso numerico.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d regola copiata in %2$s come bozza.',
		2 => '%1$d regole copiate in %2$s come bozza.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d ancoraggio in conflitto è stato rinominato con un suffisso numerico.',
		2 => '%d ancoraggi in conflitto sono stati rinominati con suffissi numerici.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Sei sicuro di voler rimuovere questa regola?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Sei sicuro di voler rimuovere questa categoria di regole?<br />Attenzione: La rimozione di una categoria di regole comporterà anche la rimozione di tutte le regole in essa contenute.',
