...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'Kirjoita johdanto, joka näytetään sääntöjen yläpuolella käyttäjille, jotka tarkastelevat sääntökokonaisuutta <strong>%s</strong>. Jätä kenttä tyhjäksi käyttääksesi paikkamerkkinä näkyvää käännettyä oletustekstiä.',
	...
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> 'Kohteessa on tällä hetkellä %d sääntöä. Ne pysyvät muuttumattomina, ja kopioidut säännöt lisätään niiden perään. Ristiriitaisiin kopioituihin ankkureihin lisätään numeerinen jälkiliite.',
	...
	'ACP_BOARDRULES_RULE_COUNT'				=> '%d sääntöä',
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> '%1$d sääntöä kopioitu kielelle %2$s luonnoksena.',
