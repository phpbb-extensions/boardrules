...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO'					=> 'Úvod stránky s pravidlami',
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Skopíruje všetky kategórie a pravidlá do <strong>%s</strong>. Skopírované pravidlá sa pridajú za existujúce pravidlá a celá cieľová sada bude nastavená ako koncept, kým ju nezverejníte.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Pridať k existujúcim pravidlám',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Cieľ teraz obsahuje %d pravidlo. Zostane nezmenené a skopírované pravidlá budú pridané zaň. Konfliktné skopírované odkazy dostanú číselnú príponu.',
		2 => 'Cieľ teraz obsahuje %d pravidlá. Zostanú nezmenené a skopírované pravidlá budú pridané za ne. Konfliktné skopírované odkazy dostanú číselnú príponu.',
		3 => 'Cieľ teraz obsahuje %d pravidiel. Zostanú nezmenené a skopírované pravidlá budú pridané za ne. Konfliktné skopírované odkazy dostanú číselnú príponu.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d pravidlo bolo skopírované do %2$s ako koncept.',
		2 => '%1$d pravidlá boli skopírované do %2$s ako koncept.',
		3 => '%1$d pravidiel bolo skopírovaných do %2$s ako koncept.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d konfliktný odkaz bol premenovaný pomocou číselnej prípony.',
		2 => '%d konfliktné odkazy boli premenované pomocou číselných prípon.',
		3 => '%d konfliktných odkazov bolo premenovaných pomocou číselných prípon.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Naozaj chcete odstrániť toto pravidlo?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Naozaj chcete odstrániť toto pravidlo?<br />Varovanie: Odstránením kategórie odstraníte tiež všetky pravidlá v nej.',
