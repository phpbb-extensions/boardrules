...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_FONT_ICON'				=> 'Ikona poveznice pravila',
	'ACP_BOARDRULES_FONT_ICON_EXPLAIN'		=> 'Unesite naziv <strong><a href="%s" target="_blank">Font Awesome</a></strong> ikone za poveznicu pravila u zaglavlju. Ostavite prazno ako ne želite ikonu.',
	'ACP_BOARDRULES_FONT_ICON_INVALID'		=> 'Ikona poveznice pravila sadrži neispravne znakove.',
	...
	'ACP_BOARDRULES_LIST_STYLE'				=> 'Stil popisa pravila',
	...
	'ACP_BOARDRULES_LIST_STYLE_NONE'		=> 'Nijedan',
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Kopirajte sve kategorije i pravila u <strong>%s</strong>. Kopirana pravila dodat će se nakon postojećih pravila, a cijeli ciljni skup pravila bit će postavljen kao skica dok ga ne objavite.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Dodaj postojećim pravilima',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Cilj trenutačno sadrži %d pravilo. Ono će ostati nepromijenjeno, a kopirana pravila dodat će se nakon njega. Svim kopiranim sidrima koja se podudaraju dodat će se brojčani sufiks.',
		2 => 'Cilj trenutačno sadrži %d pravila. Ona će ostati nepromijenjena, a kopirana pravila dodat će se nakon njih. Svim kopiranim sidrima koja se podudaraju dodat će se brojčani sufiks.',
		3 => 'Cilj trenutačno sadrži %d pravila. Ona će ostati nepromijenjena, a kopirana pravila dodat će se nakon njih. Svim kopiranim sidrima koja se podudaraju dodat će se brojčani sufiks.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d pravilo kopirano je u %2$s kao skica.',
		2 => '%1$d pravila kopirana su u %2$s kao skica.',
		3 => '%1$d pravila kopirano je u %2$s kao skica.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d podudarno sidro preimenovano je pomoću brojčanog sufiksa.',
		2 => '%d podudarna sidra preimenovana su pomoću brojčanih sufiksa.',
		3 => '%d podudarnih sidara preimenovano je pomoću brojčanih sufiksa.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Jesi li siguran/na da želiš izbrisati ovo pravilo?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Jesi li siguran/na da želiš izbrisati ovo kategorije pravila?<br />Upozorenje: izbrisivanje kategorije pravila rezultirat će izbrisivanjem svih pravila povezanih s istom.',
