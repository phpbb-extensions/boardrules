...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Копіює всі категорії та правила до <strong>%s</strong>. Скопійовані правила додаються після наявних, а повний цільовий набір правил буде переведено в статус чернетки до публікації.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Додати до наявних правил',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Зараз цільова мова містить %d правило. Воно залишиться без змін, а скопійовані правила буде додано після нього. Конфліктні скопійовані якорі отримають числовий суфікс.',
		2 => 'Зараз цільова мова містить %d правила. Вони залишаться без змін, а скопійовані правила буде додано після них. Конфліктні скопійовані якорі отримають числовий суфікс.',
		3 => 'Зараз цільова мова містить %d правил. Вони залишаться без змін, а скопійовані правила буде додано після них. Конфліктні скопійовані якорі отримають числовий суфікс.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d правило скопійовано до %2$s як чернетку.',
		2 => '%1$d правила скопійовано до %2$s як чернетку.',
		3 => '%1$d правил скопійовано до %2$s як чернетку.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d конфліктний якір перейменовано з додаванням числового суфікса.',
		2 => '%d конфліктні якорі перейменовано з додаванням числових суфіксів.',
		3 => '%d конфліктних якорів перейменовано з додаванням числових суфіксів.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Ви дійсно хочете видалити це правило?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Ви дійсно хочете видалити це правило?<br />Попередження: видалення розділу правил також призведе до видалення всіх пунктів, що входять до нього.',
