...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'Введіть текст, який відображатиметься над правилами для користувачів, що переглядають набір правил <strong>%s</strong>. Залиште поле порожнім, щоб використати перекладений типовий текст, показаний як заповнювач.',
