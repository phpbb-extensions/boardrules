...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_FONT_ICON'				=> 'Foorumi reeglite lingi ikoon',
	'ACP_BOARDRULES_FONT_ICON_EXPLAIN'		=> 'Sisesta päises oleva reeglite lingi jaoks <strong><a href="%s" target="_blank">Font Awesome</a></strong> ikooni nimi. Ikooni ärajätmiseks jäta väli tühjaks.',
	'ACP_BOARDRULES_FONT_ICON_INVALID'		=> 'Reeglite lingi ikoon sisaldas lubamatuid märke.',
	...
	'ACP_BOARDRULES_LIST_STYLE'				=> 'Foorumi reeglite loendi stiil',
	'ACP_BOARDRULES_LIST_STYLE_EXPLAIN'		=> 'Vali, kuidas reegleid ja kategooriaid tähistatakse. Järjestatud loend vaheldub numbrite, tähtede ja Rooma numbrite vahel. Järjestamata loend vaheldub täidetud ringi, ringjoone ja ruudu vahel. Liitnumeratsioon näitab täielikku numbrilist teed.',
	'ACP_BOARDRULES_LIST_STYLE_ORDERED'		=> 'Ordered alpha-numeric',
	'ACP_BOARDRULES_LIST_STYLE_UNORDERED'	=> 'Järjestamata (täidetud ring, ringjoon, ruut)',
	'ACP_BOARDRULES_LIST_STYLE_COMPOUND'	=> 'Liitnumeratsioon (1, 1.1, 1.1.1)',
	'ACP_BOARDRULES_LIST_STYLE_NONE'		=> 'Puudub',
	...
	'ACP_BOARDRULES_INTRO'					=> 'Reeglite lehe sissejuhatus',
	'ACP_BOARDRULES_INTRO_EXPLAIN'			=> 'Kohanda sissejuhatust, mida näidatakse reeglilehe <strong>%s</strong> kasutajatele. Jäta see väli tühjaks, et kasutada kohatäitena kuvatavat vaikimisi sissejuhatust.',
	'ACP_BOARDRULES_INTRO_SAVE'				=> 'Salvesta sissejuhatus',
	'ACP_BOARDRULES_INTRO_SAVED'			=> 'Reeglite lehe sissejuhatus salvestati.',
	'ACP_BOARDRULES_LANGUAGE'				=> 'Keel',
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Kopeeri kõik kategooriad ja reeglid keelde <strong>%s</strong>. Kopeeritud reeglid lisatakse olemasolevate järele ning kogu sihtkeele reeglistik määratakse mustandiks, kuni selle avaldad.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Lisa olemasolevatele reeglitele',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'Sihtkeeles on praegu %d reegel. See jääb muutmata ning kopeeritud reeglid lisatakse selle järele. Konfliktsed kopeeritud ankrud saavad numbrilise järelliite.',
		2 => 'Sihtkeeles on praegu %d reeglit. Need jäävad muutmata ning kopeeritud reeglid lisatakse nende järele. Konfliktsed kopeeritud ankrud saavad numbrilise järelliite.',
	),
	...
	'ACP_BOARDRULES_COPY_SUCCESS'			=> array(
		1 => '%1$d reegel kopeeriti keelde %2$s mustandina.',
		2 => '%1$d reeglit kopeeriti keelde %2$s mustandina.',
	),
	'ACP_BOARDRULES_COPY_ANCHORS_RENAMED'	=> array(
		1 => '%d konfliktne ankur nimetati ümber numbrilise järelliitega.',
		2 => '%d konfliktset ankrut nimetati ümber numbriliste järelliidetega.',
	),
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Oled sa kindel, et soovid eemaldada selle reegli?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Oled sa kindel, et soovid eemaldada selle reeglite kategooria?<br />Hoiatus: Reeglite kategooria eemaldamisega, eemaldad ka selles kategoorias asetsevad reeglid.',
