...
$lang = array_merge($lang, array(
	...
	'ACP_BOARDRULES_EMPTY_NOTICE'			=> 'Não existem regras neste idioma. Os utilizadores veem actualmente as regras no idioma predefinido do fórum.',
	'ACP_BOARDRULES_EMPTY_DEFAULT_NOTICE'	=> 'Não existem regras no idioma predefinido do fórum.',
	'ACP_BOARDRULES_DRAFT_NOTICE'			=> 'Estas regras não estão visíveis para os utilizadores. Os utilizadores veem actualmente as regras no idioma predefinido do fórum.',
	...
	'ACP_BOARDRULES_COPY_RULESET_EXPLAIN'	=> 'Copia todas as categorias e regras para <strong>%s</strong>. As regras copiadas são adicionadas depois das regras existentes e o conjunto completo de destino será definido como rascunho até ser publicado.',
	'ACP_BOARDRULES_COPY_APPEND'			=> 'Adicionar às regras existentes',
	'ACP_BOARDRULES_COPY_APPEND_EXPLAIN'	=> array(
		1 => 'O destino contém actualmente %d regra. Esta permanecerá inalterada e as regras copiadas serão adicionadas depois dela. As âncoras copiadas em conflito receberão um sufixo numérico.',
		2 => 'O destino contém actualmente %d regras. Estas permanecerão inalteradas e as regras copiadas serão adicionadas depois delas. As âncoras copiadas em conflito receberão um sufixo numérico.',
	),
	...
	'ACP_BOARDRULES_COPY_SOURCE_EMPTY'		=> 'O idioma de origem seleccionado não tem regras para copiar.',
	...
	'ACP_DELETE_RULE_CONFIRM'				=> 'Tem a certeza que deseja eliminar esta regra?',
	'ACP_DELETE_RULE_CATEGORY_CONFIRM'	=> 'Tem a certeza que deseja eliminar esta categoria de regra?<br />Aviso: Removendo um categoria de regra irá remover todas as regras contidas dentro dela.',
